...
## Pmod Header JA
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { SPI_0_ss_io[0] }]; #IO_L17P_T2_34 Sch=JA1_P
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { SPI_0_io0_io }]; #IO_L17N_T2_34 Sch=JA1_N
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { SPI_0_io1_io }]; #IO_L7P_T1_34 Sch=JA2_P
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { SPI_0_sck_io }]; #IO_L7N_T1_34 Sch=JA2_N
...
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33   PULLUP TRUE } [get_ports { IIC_0_scl_io }]; #IO_L1P_T0_34 Sch=JB2_P
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33   PULLUP TRUE } [get_ports { IIC_0_sda_io }]; #IO_L1N_T0_34 Sch=JB2_N
...
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33   PULLUP TRUE } [get_ports { PULLUP_HELPER_tri_i[0] }]; #IO_L4P_T0_34 Sch=JB4_P
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33   PULLUP TRUE } [get_ports { PULLUP_HELPER_tri_i[1] }]; #IO_L4N_T0_34 Sch=JB4_N
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { UART_0_txd  }]; #IO_L5P_T0_34            Sch=CK_IO0
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { UART_0_rxd  }]; #IO_L2N_T0_34            Sch=CK_IO1
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { UART_1_txd  }]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=CK_IO2
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { UART_1_rxd  }]; #IO_L3N_T0_DQS_34        Sch=CK_IO3
...
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[0] }]; #IO_L19N_T3_VREF_13  Sch=CK_IO26
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[1] }]; #IO_L6N_T0_VREF_13   Sch=CK_IO27
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[2] }]; #IO_L22P_T3_13       Sch=CK_IO28
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[3] }]; #IO_L11P_T1_SRCC_13  Sch=CK_IO29
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[4] }]; #IO_L11N_T1_SRCC_13  Sch=CK_IO30
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[5] }]; #IO_L17N_T2_13       Sch=CK_IO31
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[6] }]; #IO_L15P_T2_DQS_13   Sch=CK_IO32
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[7] }]; #IO_L21N_T3_DQS_13   Sch=CK_IO33
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[8] }]; #IO_L16P_T2_13       Sch=CK_IO34
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[9] }]; #IO_L22N_T3_13       Sch=CK_IO35
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[10] }]; #IO_L13N_T2_MRCC_13  Sch=CK_IO36
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[11] }]; #IO_L13P_T2_MRCC_13  Sch=cCK_IO37
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[12] }]; #IO_L15N_T2_DQS_13   Sch=CK_IO38
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[13] }]; #IO_L14N_T2_SRCC_13  Sch=CK_IO39
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[14] }]; #IO_L16N_T2_13       Sch=CK_IO40
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { AXI_GPIO_tri_io[15] }]; #IO_L14P_T2_SRCC_13  Sch=CK_IO41
